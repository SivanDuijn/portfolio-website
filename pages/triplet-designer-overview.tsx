  ...
  return (
    ...
    >
      <p className={clsx("mb-8")}>
        A tool that can generate a 3D shape that will cast three user-defined shadows. Such an
        object is called a triplet and was part of my Master research topic. As a practical
        deliverable I developed this website to experiment with various triplet shapes.
        <br />
        <br />
