...
/**
 */
export const ConnectednessOptions = Object.freeze({
  Volume: 0,
  0: "Volume",
  Edge: 1,
  1: "Edge",
...
/**
 */
export const ShapePlaneFillRandomness = Object.freeze({
  Fully: 0,
  0: "Fully",
  OptimalEdgesConnect: 1,
  1: "OptimalEdgesConnect",
  NeighborWeighted: 2,
  2: "NeighborWeighted",
});
/**
...
export class ShapePlane {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(ShapePlane.prototype);
    obj.__wbg_ptr = ptr;
   ...
   */
  get_js_values() {
    const ret = wasm.shapeplane_get_js_values(this.__wbg_ptr);
