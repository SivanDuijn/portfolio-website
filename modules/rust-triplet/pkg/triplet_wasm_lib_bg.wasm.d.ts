...
export function __wbg_get_triplet_r1(a: number): number;
export function __wbg_set_triplet_r1(a: number, b: number): void;
export function __wbg_get_triplet_r2(a: number): number;
export function __wbg_set_triplet_r2(a: number, b: number): void;
export function __wbg_get_triplet_r3(a: number): number;
export function __wbg_set_triplet_r3(a: number, b: number): void;
